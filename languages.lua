...
If you like this bot, please leave the vote you think it deserves [here](https://telegram.me/storebot?start=groupbutler_bot)']],
		    private = 'Hola *&&&1* '..emoji.shaking_hand..', que tal?\n'
                    ..'Soy un bot de @xxdamage para el control de sus grupos',
...
`/help` : ver este mensaje]],
		...
		banhammer = {
            kicked = '¡&&&1 ha expulsado a &&&2! (pero puede volver a entrar)',
            banned = '¡&&&1 ha baneado a &&&2!',
            unbanned = '¡Usuario desbaneado por &&&1!',
...
• *Nota*: en \"_textos_\" están incluidos el resto de tipos de multimedia (archivo, audio...)]],
        ...
        preprocess = {
            ...
            media_kick = ' *expulsado*: alcanzado el numero de avisos por Spam o multimedia no permitida',
            media_ban = ' *baneado*: alcanzado el numero de avisos por Spam o multimedia no permitida',
            ...
            arab_banned = ' *banned*: arab message detected!',
            first_warn = 'Este tipo de multimedia o SPAM *no está permitido* en este chat.\n\n👇*Avisos*'
        },
        kick_errors = {
